...
if ($_SESSION["usergroup"] = 1) {
    ...
    <div class="container">
        <?php if (!isset($_POST["prename"])) { ?>
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>">
                <label for="prename">Vorname</label> <input name="prename" id="prename" type="text">
                <label for="lastname">Nachname</label> <input name="lastname" id="lastname" type="text">
            ...
            $user = getUserID($prename,$lastname);
            getKontostand($user);
        } ?>
    </div>
    </body>
